...
export const createOrderSchema = z.object({
  body: z.object({
    ...
    status: z.enum(['NEW', 'IN_PROGRESS', 'READY_FOR_DISPATCH', 'DISPATCH_INITIATED', 'DISPATCH_PARTNER_BOOKED', 'ORDER_INITIATED', 'TASK_ASSIGNMENT', 'TASK_COMPLETION', 'TASK_APPROVED', 'TASK_REJECTED', 'ORDER_SHIPPED', 'ORDER_DELIVERED']).optional(),
  }),
